export const manifest = {
  screens: {
    ...
    scr_eog1f2: { name: "Approvals", route: "/approvals", position: { "x": 160, "y": 5780 } },
    scr_ffozxg: { name: "Approve & send message", route: "/approvals/shp-1", position: { "x": 1560, "y": 5780 } },
    scr_zrt9dy: { name: "Case: Message sent", route: "/approvals/shp-4", position: { "x": 2960, "y": 5780 } },
    scr_6kxvd4: { name: "Connection & sync", route: "/connections", position: { "x": 160, "y": 7760 } },
    scr_fjqey8: { name: "Connection: Data sources", route: "/connections", state: { "tab": "data" }, position: { "x": 2960, "y": 7760 } },
    scr_vv3jlx: { name: "Connection: Sync history", route: "/connections", state: { "tab": "sync" }, position: { "x": 4360, "y": 7760 } },
    scr_6vgafn: { name: "Connection: Order status", route: "/connections", state: { "tab": "status" }, position: { "x": 1560, "y": 7760 } },
    scr_agof5y: { name: "Orders", route: "/orders", position: { "x": 160, "y": 1820 } },
    scr_72npz0: { name: "Order: Needs uploads", route: "/orders/shp-4", position: { "x": 2960, "y": 1820 } },
    scr_r1g328: { name: "Order: Message to customer", route: "/orders/shp-4", state: { "tab": "message" }, position: { "x": 4360, "y": 1820 } },
    scr_v3d5en: { name: "Order: Picked up", route: "/orders/shp-2", position: { "x": 5760, "y": 1820 } },
  ...
  sections: {
    sec_c0diy3: { name: "Orders", x: 0, y: 1600, width: 7120, height: 1180 },
    sec_bfho7i: { name: "Executions", x: 0, y: 3580, width: 4320, height: 1180 },
    sec_zv7ltg: { name: "Approvals", x: 0, y: 5560, width: 4320, height: 1180 },
    sec_q4xgzp: { name: "Connection & sync", x: 0, y: 7540, width: 5720, height: 1180 },
